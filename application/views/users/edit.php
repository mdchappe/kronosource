<div class="container edit-wrap">
	<div class="edit-inner">
		...
		<?php echo form_open('users/edit'); ?>
			...
			<label class="edit-username" for="username">User Name<small><b> (min 6 characters, max 18 characters)</b></small></label><br/>
			...
			<input class="btn btn-primary edit-btn" type="submit" name="submit" value="submit" /><a class="btn btn-danger" href="/index.php">cancel</a>
		</form>
	</div>		
</div>